...
@InputType()
export class category_bookUpsertWithWhereUniqueWithoutCategory_category_book_categoryTocategoryInput {
    ...
    update!: category_bookUpdateWithoutCategory_category_book_categoryTocategoryInput;
